/**
 * proceduralAudio.ts -- 漢字マージ
 * ---------------------------------------------------------------
 * Web Audio API によるプロシージャル BGM / SE 生成モジュール v2.0
 *
 * ジャンル: Japanese Lo-Fi / Koto-inspired
 * BPM: 92 (通常) / 110 (フィーバー)
 * キー: D (major_penta)
 *
 * 特徴:
 * - 5声部 BGM (メロディ + サブメロディ + ベース + コードパッド + ドラム)
 * - フィーバー時: BPM+18, アルペジオ追加, フィルター解放, コンプ感UP
 * - 緊張モード: BPM+28, マイナー転調, 8分ドラム
 * - リバーブ (マルチタップディレイ)
...
const PRESET: GamePreset = {
  ...
  chordProgression: 'lofi',
  melodyOctave: 5,
  melodyWave: 'sine',
  melodyVolume: 0.13,
  melodyNoteDensity: 0.5,
  subMelodyWave: 'triangle',
  subMelodyOctave: 4,
  subMelodyVolume: 0.05,
  bassWave: 'sine',
  bassOctave: 2,
  bassVolume: 0.16,
  bassStyle: 'sustained',
